...
class CameraTests extends TestFixture {
    ...
    cameraAtRightEdgeCanSeeDrawableAtLeftEdge() {
        ...
        var colliderCamera = ShapeWrapped.fromSizeInWrappedInstancesSizeToWrapToAndChild(sizeInWrappedInstances, sizeToWrapTo, BoxAxisAligned.fromSize(viewSize)).toShapeGroupAny();
        var colliderDrawable = ShapeWrapped.fromSizeInWrappedInstancesSizeToWrapToAndChild(sizeInWrappedInstances, sizeToWrapTo, Sphere.fromRadius(4)).toShapeGroupAny();
        ...
        var locatableDrawable = Locatable.fromPos(sizeToWrapTo.clone().subtract(offsetFromEdge));
        var entityCamera = Entity.fromNameAndProperties(Camera.name, [collidableCamera, locatableCamera]);
        var entityDrawable = Entity.fromNameAndProperties(Drawable.name, [collidableDrawable, locatableDrawable]);
